  ...
  <v-container fluid pa-0 ma-0>
    ...
    <v-container class="mt-12">
      <v-row justify="center" align="center">
        <v-col cols="12" lg="10" class="d-flex flex-column">
          ...
          <h2 class="text-center"><strong>Contentfulテスト</strong></h2>
          <v-btn 
            depressed
            color="primary"
            class="mx-auto"
          ...
          <img src="../assets/images/untree.co_dashboard_mocklayout_laptop.png" alt="image" class="mt-5">
        </v-col>
      </v-row>
    </v-container>
    ...
    <v-container>
      ...
      <v-row justify="center" align="center" class="mb-5">
        <v-col lg="6" class="mb-5 order-lg-2 mb-lg-0">
          <img src="../assets/images//untree.co_dashboard_mocklayout.jpg" alt="Image" class="img-fluid img-shadow" style="width: 100%;">
        </v-col>

        <v-col lg="5" class="mr-auto">
          <div class="mb-4">
      ...
      <v-row justify="center" align="center">
        <v-col lg="6" class="mb-5 mb-lg-0">
          <img src="../assets/images/untree.co_dashboard_mocklayout.jpg" alt="Image" class="img-fluid img-shadow" style="width: 100%;">
        </v-col>
        <v-col lg="5" class="order-lg-1 ml-auto">
          <div class="mb-4">
